...
<head>
    ...
    <meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, CdBurning-scalable=no" name="viewport" />
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">修改光盘刻录信息</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        <h1 class="page-header">光盘刻录管理 <small>修改光盘刻录信息</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">修改光盘刻录信息</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        <!-- begin wizard-form -->
                        <form id="" name="form-CdBurningEdit" class="form-control-with-bg form-horizontal" data-parsley-validate="true">
                            <!-- begin row -->
                            <div class="row">
                                <!--光盘刻录id-->
                                <input type="hidden" name="cdBurningId" value="${cdBurning.id}"/>
                                <!-- begin col-8 -->
                                <div class="col-md-8 offset-md-2">
                                    <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">修改光盘刻录信息请修改以下内容</legend>
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="url" id="url" class="form-control" data-parsley-remote data-parsley-remote-validator='checkurl' data-parsley-remote-message="输入的路径已存在"  data-parsley-required="true" data-parsley-required-message="此项不能为空" value="${cdBurning.url}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="orderNum" id="orderNum" class="form-control" data-parsley-required="true" data-parsley-required-message="此项不能为空" value="${cdBurning.orderNum}"/>
                                        </div>
                                    </div>
                                    <!-- end form-group--光盘刻录路径名称 -->
...
<asset:javascript src="cdBurning/edit.js"/>
<script>
