            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">排期列表</h4>
                    </div>

                    <div class="panel-body">
                    <!-- 区分v2预告 -->
                        <g:if test="${grailsApplication.config.pageVersion == 'v2'}">
                            <input type="text" name="pageType" class="form-control" id="pageType" value="trialNotice"
                                   hidden="hidden"/>
                        </g:if>

                        <div class="form-group row m-b-10">
                            <label class="text-md-right col-form-label width-sm width-5per">案号：</label>
                            ...
                            <div class="col-md-2">
                                <select class="form-control selectpicker" data-size="10" data-live-search="true"
                                        data-style="btn-white" id="courtroom" name="courtroom"
                            ...
                            <div class="col-md-2">
                                <select class="form-control selectpicker" data-size="10" data-live-search="true"
                                        data-style="btn-white" id="judge" name="judge" data-parsley-group="step-3"
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-2">
                                <select class="form-control selectpicker" data-size="10" data-live-search="true"
                                        data-style="btn-white" id="secretary" name="secretary"
                                        data-parsley-group="step-3" data-parsley-required="true">
                                    <option value="" selected="selected">请选择</option>
                            ...
                            <g:if test="${grailsApplication.config.pageVersion == 'v1'}">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control selectpicker" data-size="10" data-live-search="true"
                                            data-style="btn-white" id="status" name="status" data-parsley-group="step-3"
                                            data-parsley-required="true">
                                        <option value="" selected="selected">请选择</option>
                        ...
                        <div class="form-group row m-b-10">
                            <div class="col-md-6 text-md-left">
                                <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/plan/add'>
                                    <g:link controller="plan" action="add" class="btn btn-sm btn-inverse btn-add"><i
                                            class="fa fa-plus m-r-5"></i> 添加新排期</g:link>
                                </sec:ifAnyGranted>

                                <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/plan/addCombineCasePlan'>
                                    <a href="javascript:void(0);" id="combinedPlan"
                                       class="btn btn-sm btn-inverse btn-add"><i class="far fa-bookmark m-r-5"></i>
                                        合并所选排期</a>
                                </sec:ifAnyGranted>
                                <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/plan/del'>
                                    <a href="javascript:void(0);" id="checkedBtn"
                                       class="btn btn-sm btn-inverse btn-del"><i class="fa fa-times m-r-5"></i> 删除所选排期
                                    </a>
                                </sec:ifAnyGranted>
                                <g:if test="${grailsApplication.config.pageVersion == 'v1'}">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-inverse btn-add" id="morePlanAdd"><i
                                            class="fas fa-angle-double-down m-r-5"></i> 排期批量导入</a>
                                    <a href="javascript:void(0)" class="btn btn-sm btn-inverse btn-add" id="exportExcel"><i
                                            class="fas fa-angle-double-up m-r-5"></i> 根据检索条件批量排期导出</a>
                                    <a href="${contentPath}/login/download?file=排期批量导入模板.xls"
                                       class="btn btn-sm btn-inverse btn-add" id="exportExcel">
                                        <i class="fas fa-cloud-download-alt m-r-5"></i> 排期批量导入模板下载
                                    </a>
                                </g:if>
                            </div>
                        </div>
