    ...
    <div id="content" class="content">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <g:form controller="ctrl" action="editSaveButtons" id="${roomId}" method="POST">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="codeUp" value="${codeUp}" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="img" value="${img}" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <div class="form-group row m-b-10">
...
<asset:javascript src="ctrl/editButtons.js"/>
<script>
