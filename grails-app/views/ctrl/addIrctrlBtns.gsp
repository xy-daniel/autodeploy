...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">添加红外按钮</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">审理庭控制 <small>添加红外按钮</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">添加红外按钮</h4>
            </div>
            <input id="courtroom" type="hidden" value="${courtroom.id}"/>
            <div class="panel-body">
                <g:form controller="ctrl" action="addSaveIrctrlBtn" id="${courtroom.id}" method="POST">
%{--                    红外控制的UUID--}%
...
<asset:javascript src="ctrl/addIrctrlBtns.js"/>
<script>
