...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">修改电源按钮</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">审理庭控制 <small>修改电源按钮</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">修改电源按钮</h4>
            </div>
            <input id="courtroom" type="hidden" value="${courtroom.id}"/>
            <input id="powerNewUid" type="hidden" value="${powerNewUid}"/>
            <input id="uuid" type="hidden" value="${uuid}"/>
            <div class="panel-body">
                <g:form controller="ctrl" action="editSavePowerNewBtn" id="${courtroom.id}" method="POST">
                    <div class="col-md-8 offset-md-2">
                        <!-- begin uuid -->
                        <input name="powerNewUid" type="hidden" value="${powerNewUid}"/>
...
<asset:javascript src="ctrl/editpowerNewBtns.js"/>
<script>
