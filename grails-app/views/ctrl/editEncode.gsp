...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">配置与管理 <small>修改编码器</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">修改编码器</h4>
            </div>
            <input id="courtroom" type="hidden" value="${roomId}"/>

            <div class="panel-body">
                <g:form controller="ctrl" action="editSaveEncode" id="${roomId}" method="POST">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">本地名称</label>

                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="name" value="${name}"
                        ...
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">编码器IP</label>

                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="encodeip" value="${encodeip}"
                                       data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">通道名称</label>

                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="number" value="${number}"
                                       data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">是否可以录制</label>

                            <div class="col-md-6">
                                <div class="radio radio-css radio-inline">
                                    <input type="radio" name="record" id="record1" value="1"
                                           <g:if test="${record == '1'}">checked</g:if>/>
                                    <label for="record1">是</label>
                                </div>

                                <div class="radio radio-css radio-inline">
                                    <input type="radio" name="record" id="record2" value="0"
                                           <g:if test="${record == '0'}">checked</g:if>/>
                                    <label for="record2">否</label>
                                </div>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="order" value="${order}"
                                       data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
...
<asset:javascript src="ctrl/editEncode.js"/>
<script>
