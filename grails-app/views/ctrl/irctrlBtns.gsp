...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">红外按钮列表</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">审理庭控制 <small>红外按钮列表</small></h1>
        <!-- end page-header -->
        <!-- begin courtroom_id -->
        <input id="courtroom" type="hidden" value="${courtroom.id}"/>
        <input id="irctrlUid" type="hidden" value="${uuid}"/>
        <!-- end courtroom_id -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">红外按钮列表</h4>
            </div>
                ...
                <div class="tab-pane">
                    <div class="table-btn-row m-b-15">
                        <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_MONITOR'>
                            <g:link url="${createLink(uri: '/')}ctrl/irctrl/button/add/${courtroom.id}/${uuid}" class="btn btn-sm btn-inverse btn-add"><i class="fa fa-plus m-r-5"></i> 添加红外按钮</g:link>
                            <a href="javascript:void(0);" id="delButtons" class="btn btn-sm btn-inverse btn-del"><i class="fa fa-times m-r-5"></i> 删除所选红外按钮</a>
                        </sec:ifAnyGranted>
                    </div>
...
<asset:javascript src="ctrl/irctrlBtns.js"/>
<script>
