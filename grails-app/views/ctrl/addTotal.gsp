...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">配置与管理 <small>添加综合控制</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">添加综合控制</h4>
            </div>
            <input id="courtroom" type="hidden" value="${courtroom.id}"/>
            <div class="panel-body">
                <g:form controller="ctrl" action="addSaveTotal" id="${courtroom.id}" method="POST">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <!-- end form-group row -->
                        <!-- begin form-group row sendTime -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 col-form-label text-md-right">发送时间 </label>
                            <div class="col-md-6">
                                <div class="input-group date" id="datetimepicker">
                                    <input type="text" class="form-control" name="sendTime"  data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                        ...
                        <!-- end form-group row -->
                        <!-- begin form-group row sendPriority -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 col-form-label text-md-right">发送优先级 </label>
                            <div class="col-md-6">
                                <select class="form-control selectpicker" data-size="10" data-style="btn-white" name="sendPriority" data-parsley-required="true" data-parsley-required-message="此项不能为空">
...
<asset:javascript src="ctrl/addTotal.js"/>
<script>
