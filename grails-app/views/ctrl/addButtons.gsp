...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">配置与管理 <small>添加摄像头控制指令</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">添加摄像头控制指令</h4>
            </div>
            <input id="courtroom" type="hidden" value="${courtroom.id}"/>
            <div class="panel-body">
                <g:form controller="ctrl" action="addSaveButtons" id="${courtroom.id}" method="POST">
                    <div class="col-md-8 offset-md-2">
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">控制名称 </label>
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="name" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">按下指令 </label>
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="codeDown" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">放开指令 </label>
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="codeUp" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">状态 </label>
                            <div class="col-md-6">
                                <div class="radio radio-css radio-inline">
                                    <input type="radio" name="visible" id="visible1" value="1" checked />
                                    <label for="visible1">可见</label>
                                </div>
                                <div class="radio radio-css radio-inline">
                                    <input type="radio" name="visible" id="visible2" value="0" />
                        ...
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">图标 </label>
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="img" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- end form-group row -->
...
<asset:javascript src="ctrl/addButtons.js"/>
