...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">配置与管理 <small>修改输出控制</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">修改输出控制</h4>
            </div>
            <input id="courtroom" type="hidden" value="${roomId}"/>
            <div class="panel-body">
                <g:form controller="ctrl" action="editSaveTotal" id="${roomId}" method="POST">
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date" id="datetimepicker">
                                    <input type="text" class="form-control" name="sendTime" value="${sendTime}" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <select class="form-control selectpicker" data-size="10" data-style="btn-white" name="sendPriority" data-parsley-required="true" data-parsley-required-message="此项不能为空">
                                    ...
                                    <option value="1" <g:if test="${sendPriority=='1'}"> selected </g:if>>优</option>
                                    <option value="2" <g:if test="${sendPriority=='2'}"> selected </g:if>>良</option>
                                    <option value="3" <g:if test="${sendPriority=='3'}"> selected </g:if>>中</option>
                                    <option value="4" <g:if test="${sendPriority=='4'}"> selected </g:if>>差</option>
                                </select>
                            </div>
                        </div>
                        <!-- end form-group row -->
...
<asset:javascript src="ctrl/editTotal.js"/>
<script>
