...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">配置与管理 <small>修改红外控制</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">修改红外控制</h4>
            </div>
            <input id="courtroom" type="hidden" value="${roomId}"/>
            <div class="panel-body">
                <g:form controller="ctrl" action="editSaveIrctrl" id="${roomId}" method="POST">
...
<asset:javascript src="ctrl/editIrctrl.js"/>
<script>
