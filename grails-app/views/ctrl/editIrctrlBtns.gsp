...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">修改红外按钮</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">审理庭控制 <small>修改红外按钮</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">修改红外按钮</h4>
            </div>
            <input id="courtroom" type="hidden" value="${courtroom.id}"/>
            <input id="irctrlUid" type="hidden" value="${irctrlUid}"/>
            <input id="uuid" type="hidden" value="${uuid}"/>
            <div class="panel-body">
                <g:form controller="ctrl" action="editSaveIrctrlBtn" id="${courtroom.id}" method="POST">
                    <div class="col-md-8 offset-md-2">
                        <!-- begin uuid -->
                        <input name="irctrlUid" type="hidden" value="${irctrlUid}"/>
...
<asset:javascript src="ctrl/editIrctrlBtns.js"/>
<script>
