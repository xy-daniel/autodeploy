...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">配置与管理 <small>修改音量控制</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">修改音量控制</h4>
            </div>
            <input id="courtroom" type="hidden" value="${roomId}"/>
            <div class="panel-body">
                <g:form controller="ctrl" action="editSaveSound" id="${roomId}" method="POST">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="group" value="${group}" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
...
<asset:javascript src="ctrl/editSound.js"/>
<script>
