                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <div class="table-btn-row m-b-15">
                            <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/employee/add'>
                                <g:link controller="employee" action="add" class="btn btn-sm btn-inverse btn-add"><i class="fa fa-plus m-r-5"></i> 添加新职员</g:link>
                            </sec:ifAnyGranted>
                            <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/employee/del'>
                                <a href="javascript:void(0);" id="checkedBtn" class="btn btn-sm btn-inverse btn-del"><i class="fa fa-times m-r-5"></i> 删除所选职员</a>
                            </sec:ifAnyGranted>
                        </div>
                        <table id="data-table" class="table table-striped table-bordered display" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap">职位</th>
                                    <th class="text-nowrap">所属部门</th>
...
<asset:javascript src="employee/list.js"/>
<script>
