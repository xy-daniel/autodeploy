...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">修改职员信息</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        <h1 class="page-header">人员管理 <small>修改职员信息</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">修改职员信息</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        <!-- begin wizard-form -->
                        <form controller="employee" action="save" id="form-useradd" name="form-empedit" class="form-control-with-bg form-horizontal" data-parsley-validate="true">
                            <!-- begin row -->
                            <div class="row">
                                <!-- begin col-8 -->
                                <div class="col-md-8 offset-md-2">
                                    <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">修改职员信息请填写以下内容</legend>
                                    <!-- 职员id -->
                                    <input name="empId" type="hidden" value="${employee.id}">
%{--                                    <!--职员姓名-->--}%
%{--                                    <input id="namePo" type="hidden" value="${employee.name}"/>--}%
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                                <input type="text" name="name" id="name" class="form-control" value="${employee.name}" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                                        </div>
                                    </div>
                                    <!-- end form-group--职员姓名 -->
                                    <!-- begin form-group--职位 -->
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control selectpicker" data-size="10" data-style="btn-white" id="position" name="position" data-parsley-required="true" data-parsley-required-message="此项不能为空" >
                                                ...
                                                <option value="法官" <g:if test="${employee.position == 2}">selected</g:if>>法官</option>
                                                <option value="书记员" <g:if test="${employee.position == 6}">selected</g:if>>书记员</option>
                                                <option value="司法警官" <g:if test="${employee.position == 7}">selected</g:if>>司法警官</option>
                                                <option value="其他" <g:if test="${employee.position == 255}">selected</g:if>>其他</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- end form-group--所属部门 -->
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control selectpicker plan-add-case-type" data-size="10" data-live-search="true" data-style="btn-white" id="deptId" name="deptId" data-parsley-required="true" data-parsley-required-message="此项不能为空" >
                                                <option value="">请选择</option>
                                                <g:if test="${employee.dept!=null}">
                                                    <g:each in="${depts}" var="dp" status="i">
                                                        <option value="${dp.id}" <g:if test="${dp.id == employee.dept.id}">selected</g:if> >
                                                            ${dp.name}
                                                        </option>
                                                    </g:each>
                                                </g:if>
