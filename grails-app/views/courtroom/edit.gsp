    ...
    <div id="content" class="content">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <g:form controller="courtroom" action="editSave" id="${courtroom.id}" method="POST"
                        data-parsley-validate="true">
                    <input id="courtroom" type="hidden" name="id" value="${courtroom.id}"/>
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="name" value="${courtroom.name}"
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="liveIp" value="${courtroom.liveIp}"
                                       data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <select name="deviceType" class="form-control m-b-5" data-parsley-required="true"
                                    ...
                                    <option value="TCP"
                                            <g:if test="${courtroom.deviceType == "TCP"}">selected</g:if>>TCP</option>
                                    <option value="UDP"
                                            <g:if test="${courtroom.deviceType == "UDP"}">selected</g:if>>UDP</option>
                                </select>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="storeIp"
                                       value="${courtroom.storeIp}" data-parsley-required="true"
                                       data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="rtsp" placeholder="双方远程只使用此地址"
                                       value="${courtroom.rtsp}"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="rtsp1" value="${courtroom.rtsp1}"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <select name="open" class="form-control m-b-5" data-parsley-required="false">
                                    <option value="1"
                                            <g:if test="${courtroom.open == 1 || courtroom.open == null || courtroom.open == ""}">selected</g:if>>是</option>
                                    <option value="0" <g:if test="${courtroom.open == 0}">selected</g:if>>否</option>
                                </select>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <select name="isCalled" class="form-control m-b-5" data-parsley-required="false">
                                    <option value="1"
                                            <g:if test="${courtroom.isCalled == 1 || courtroom.isCalled == null || courtroom.isCalled == ""}">selected</g:if>>允许</option>
                                    <option value="0"
                                            <g:if test="${courtroom.isCalled == 0}">selected</g:if>>禁止</option>
                                </select>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <select name="status" class="form-control m-b-5" data-parsley-required="true"
                                        data-parsley-required-message="此项不能为空">
                                    <option value="1"
                                            <g:if test="${courtroom.status == 1}">selected</g:if>>正常使用</option>
                                    <option value="0"
                                            <g:if test="${courtroom.status == 0}">selected</g:if>>停止使用</option>
                                    <option value="3"
                                            <g:if test="${courtroom.status == 3}">selected</g:if>>非正常状态</option>
                                </select>
                            </div>
                        </div>
                        <!-- end form-group row -->
...
<asset:javascript src="courtroom/edit.js"/>
<script>
