...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <!-- begin #sidebar -->
    <g:render template="/layouts/base_sidebar" model="[active: 4010]"/>
    <!-- end #sidebar -->
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item">
                <g:link controller="trialVideo" action="list">庭审点播</g:link>
            </li>
            <li class="breadcrumb-item active">案件详情</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">庭审点播 <small>案件详情</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
...
<asset:javascript src="trialVideo/show.js"/>
<script>
