            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <!-- begin wizard-form -->
                        <form action="${createLink(uri: '/')}role/addSave" id="form-useradd" name="form-useradd"
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="authority" id="authority" class="form-control"
                                                   ...
                                                   data-parsley-remote-message="输入的角色名称已存在" data-parsley-required="true"
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="remark" name="remark" class="form-control"
                                                   data-parsley-required="true" data-parsley-remote
                                                   data-parsley-remote-validator='checkremark'
