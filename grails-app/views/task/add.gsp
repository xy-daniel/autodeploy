...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <!-- begin #sidebar -->
    <g:render template="/layouts/base_sidebar" model="[active: 30001]"/>
    <!-- end #sidebar -->
    ...
    <div id="content" class="content p-t-0">
        ...
        <ol class="breadcrumb pull-right">
            <li class="breadcrumb-item">
                <g:link controller="index">首页</g:link>
            </li>
            <li class="breadcrumb-item">
                <g:link controller="task" action="list">任务中心</g:link>
            </li>
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <g:form controller="task" action="addSave" method="POST" data-parsley-validate="true">
                    <div class="row">
                            ...
                            <div>
                                <g:each in="${appList}" var="app">
                                    ...
                                    <g:each in="${app.versions}" var="version">
                                        <g:if test="${version.del == null || version.del == "no"}">
...
<asset:javascript src="task/add.js"/>
<script>
