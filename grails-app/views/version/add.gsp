...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <!-- begin #sidebar -->
    <g:render template="/layouts/base_sidebar" model="[active: 20004]"/>
    <!-- end #sidebar -->
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item"><g:link controller="version" action="list" id="${appId}">版本管理</g:link></li>
            <li class="breadcrumb-item active">添加版本</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <g:form controller="version" action="addSave" id="${appId}" method="POST" data-parsley-validate="true">
                    <div class="col-md-8 offset-md-2">
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">版本号<span class="text-danger">*</span>
                            </label>

                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="number" data-parsley-required="true"
                                       data-parsley-required-message="此项不能为空"/>
                                <input type="file" name="software" id="software" class="btn p-l-0" multiple/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <div class="form-group row m-b-10">
...
<asset:javascript src="version/add.js"/>
<script>
