...
<body>
<!-- begin #sidebar -->
<g:render template="/leader/leader_sidebar" model="[active: 20100]"/>
<!-- end #sidebar -->
<!-- begin row -->
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    <div id="content" class="content" >
        ...
        %{--                <g:link controller="message" action="index">返回首页</g:link>--}%
        %{--                <g:link controller="leader" action="list">案件列表</g:link>--}%
        %{--            </li>--}%
        %{--        </ol>--}%
        %{--    </div>--}%
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item">案件排期</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">案件排期</h1>
        <!-- end page-header -->
        <!-- end breadcrumb -->
        <div class="row" >
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse" style="height: 100%;">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title" style=" color: white">排期列表</h4>
                    </div>
...
<asset:javascript src="leader/query.js"/>
<script>
