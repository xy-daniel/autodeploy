...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <!-- begin #sidebar -->
    <g:render template="/layouts/base_sidebar" model="[active: 30101]"/>
    <!-- end #sidebar -->
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">基础信息管理-法院管理</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">业务管理 <small>法院管理</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">法院信息编辑</h4>
            </div>
            <div class="panel-body">
                <g:form controller="court" action="courtSave" id="${court.id}" method="POST">
                    <div class="col-md-8 offset-md-2">
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">院名称</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="ext1" value="${court.ext1}" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                                <small class="f-s-12 text-grey-darker">必填</small>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">院简称</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="ext2" value="${court.ext2}" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                                <small class="f-s-12 text-grey-darker">必填</small>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">院代码</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="val" value="${court.val}" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                                <small class="f-s-12 text-grey-darker">必填</small>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <!-- begin form-group row -->
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label">院分级码</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="ext3" value="${court.ext3}" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                                <small class="f-s-12 text-grey-darker">必填</small>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/court/courtSave'>
                            <div class="form-group row m-b-10">
...
<asset:javascript src="court/index.js"/>
<script>
