...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">添加新部门</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        <h1 class="page-header">部门管理 <small>添加新部门</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">添加新部门</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        <!-- begin wizard-form -->
                        <form controller="department" action="addSave" id="form-useradd" name="form-useradd" class="form-control-with-bg form-horizontal" data-parsley-validate="true">
                            <!-- begin row -->
                            <div class="row">
                                <!-- begin col-8 -->
                                <div class="col-md-8 offset-md-2">
                                    ...
                                    <div class="form-group row m-b-10">
                                        <label class="col-md-3 col-form-label text-md-right">上级部门 &nbsp;&nbsp;</label>
                                        <div class="col-md-6">
                                            <select class="form-control selectpicker plan-add-case-type" data-size="10" data-live-search="true" data-style="btn-white" name="departmentId" data-parsley-required="false">
                                                ...
                                                <g:each in="${departmentList}" var="dp" status="i">
                                                    <option value="${dp.id}" <g:if test="${dp.id == id}">selected</g:if>>
                                                        ${dp.name}
                                                    </option>
                                                </g:each>
                                            </select>
...
<asset:javascript src="department/add.js"/>
<script>
