...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">更新案件类型</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        <h1 class="page-header">案件类型管理 <small>更新案件类型</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">更新案件类型</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        <!-- begin wizard-form -->
                        <form action="" id="form-useradd" name="form-useradd" class="form-control-with-bg form-horizontal" data-parsley-validate="true">
                            <!-- begin row -->
                            <div class="row">
                                <!-- begin col-8 -->
                                <div class="col-md-8 offset-md-2">
                                    <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">更新类型信息请填写以下内容</legend>
                                    <!-- 类型主键 -->
                                    <input name="ctId" type="hidden" value="${ct.id}">
                                    <!-- 类型名称 -->
                                    <input id="namePo" type="hidden" value="${ct.name}"/>
                                    <!-- begin form-group--类型代字 -->
                                    <div class="form-group row m-b-10">
                                        <label class="col-md-3 col-form-label text-md-right" for="shortName">类型代字 &nbsp;&nbsp;</label>
                                        <div class="col-md-6">
                                            <input type="text" name="shortName" id="shortName" class="form-control" value="${ct.shortName}" data-parsley-required="false"/>
                                        </div>
                                    </div>
                                    <!-- end form-group--类型代字 -->
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="code" id="code" class="form-control" value="${ct.code}"
                                    ...
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                                <input type="text" name="name" id="name" class="form-control" value="${ct.name}" data-parsley-remote data-parsley-remote-validator='checkname' data-parsley-remote-message="该部门已存在" data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                                        </div>
                                    </div>
                                    <!-- end form-group--类型名称 -->
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control selectpicker plan-add-case-type" data-size="10" data-live-search="true" data-style="btn-white" name="typeId" data-parsley-required="false">
                                                ...
                                                <g:each in="${types}" var="type" status="i">
                                                    <option value="${type.id}" <g:if test="${type.id == ct.parentId}">selected</g:if> >
                                                        ${type.name}
                                                    </option>
                                                </g:each>
                                            </select>
...
<asset:javascript src="type/edit.js"/>
<script>
