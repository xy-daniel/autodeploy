...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item">案件类型管理</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">案件类型管理</h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">类型列表</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        <div class="table-btn-row m-b-15">
                            <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/caseType/add'>
                                <a href="javascript:void(0);" id="addCaseType" class="btn btn-sm btn-inverse btn-add"><i
                                        class="fa fa-plus m-r-5"></i> 添加新类型</a>
                            </sec:ifAnyGranted>
                            <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_/caseType/del'>
                                <a href="javascript:void(0);" id="checkedBtn" class="btn btn-sm btn-inverse btn-del"><i class="fa fa-times m-r-5"></i> 删除所选类型</a>
                            </sec:ifAnyGranted>
                        </div>
                        <table id="data-table" class="table table-striped table-bordered display" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap">案件类型代字</th>
                                    <th class="text-nowrap">案件类型标识</th>
                                    <th class="text-nowrap">案件类型名称</th>
                                    <th class="text-nowrap">上级案件类型</th>
...
<asset:javascript src="type/list.js"/>
<script>
