%{--
    2021.04.26 >>> 增加语音传唤模板设置按钮 daniel
--}%
<!DOCTYPE html>
    ...
    <div id="content" class="content">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">羁押室设备列表</h4>
            </div>

            <div class="panel-body">
                <div class="table-btn-row m-b-15">
                    <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/detentionDevice/add'>
                        <g:link controller="detentionDevice" action="add" class="btn btn-sm btn-inverse"><i
                                class="fa fa-plus m-r-5"></i> 添加羁押室设备</g:link>
                    </sec:ifAnyGranted>
                    <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/detentionDevice/del'>
                        <a href="javascript:void(0);" id="checkedBtn" class="btn btn-sm btn-inverse"><i
                                class="fa fa-times m-r-5"></i> 删除所选羁押室设备</a>
                    </sec:ifAnyGranted>
                    <a href="javascript:void(0);" id="voiceSet" class="btn btn-sm btn-inverse"><i
                            class="fas fa-cog fa-spin"></i> 传唤模板设置</a>
                </div>
                <table id="data-table" class="table table-striped table-bordered display width-full">
                    ...
                    <tr>
                        ...
                        <th class="text-nowrap">设备地址</th>
                        <th class="text-nowrap">设备端口</th>
                        <th class="text-nowrap">所属法庭</th>
                        <th class="text-nowrap">在线状态</th>
                        <th class="text-nowrap">设备版本</th>
                        <th class="text-nowrap">设备状态</th>
...
<asset:javascript src="detentionDevice/list.js"/>
<script>
