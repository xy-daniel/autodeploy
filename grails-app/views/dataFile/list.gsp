...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item"><g:link controller="dataTable" action="list"
                                                id="${dataTable.device.id}">数据库管理</g:link></li>
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <table id="data-table" class="table table-striped table-bordered display width-full">
                    <thead>
                    <tr>
                        <th class="text-nowrap">表名</th>
                        <th class="text-nowrap">存储地址</th>
                        <th class="text-nowrap">占用空间(M)</th>
                        <th class="text-nowrap">备份时间</th>
    ...
    <input type="hidden" id="tableId" value="${dataTable.id}">
</div>
<!-- end page container -->
...
<asset:javascript src="dataFile/list.js"/>
<script>
