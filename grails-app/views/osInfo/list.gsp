...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item">服务器详情</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">服务器详情</h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered display" style="width:100%">
                            <thead>
                            <tr>
                               %{-- <th class="text-nowrap">内存总空间</th>
                                <th class="text-nowrap">内存剩余空间</th>
                                <th class="text-nowrap">内存使用率</th>--}%
                                <th class="text-nowrap">磁盘路径</th>
                                <th class="text-nowrap">磁盘总空间</th>
...
<asset:javascript src="osInfo/list.js"/>
<script>
