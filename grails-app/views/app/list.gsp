...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <!-- begin #sidebar -->
    <g:render template="/layouts/base_sidebar" model="[active: 20000]"/>
    <!-- end #sidebar -->
    ...
    <div id="content" class="content">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">应用列表</h4>
            </div>

            <div class="panel-body">
                <div class="table-btn-row m-b-15">
                    <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/courtroom/add'>
                        <g:link controller="app" action="add" class="btn btn-sm btn-inverse btn-add"><i
                                class="fa fa-plus m-r-5"></i> 添加应用</g:link>
                    </sec:ifAnyGranted>
                </div>
                <table id="data-table" class="table table-striped table-bordered display width-full">
                    <thead>
                    <tr>
                        <th class="text-nowrap">应用名称</th>
                        <th class="text-nowrap">安装包名称</th>
...
<asset:javascript src="app/list.js"/>
<script>
