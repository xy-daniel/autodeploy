...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <!-- begin #sidebar -->
    <g:render template="/layouts/base_sidebar" model="[active: 20002]"/>
    <!-- end #sidebar -->
    ...
    <div id="content" class="content">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">编辑应用</h4>
            </div>

            <div class="panel-body">
                <g:form controller="app" action="editSave" id="${app.id}" method="POST"
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="itemName" value="${app.itemName}"
...
<asset:javascript src="app/edit.js"/>
<script>
