%{--
    远程法院列表页面 created by daniel in 2021.04.19
--}%
<!DOCTYPE html>
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">配置与管理 <small>远程提讯</small></h1>
        <!-- end page-header -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">法院列表</h4>
            </div>

            <div class="panel-body">
                <div class="table-btn-row m-b-15">
                    <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/distanceCourt/add'>
                        <a href="javascript:void(0);" id="addDc" class="btn btn-sm btn-inverse btn-add"><i
                                class="fa fa-plus m-r-5"></i> 添加法院</a>
                    </sec:ifAnyGranted>
                    <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/distanceCourt/del'>
                        <a href="javascript:void(0);" id="checkedBtn" class="btn btn-sm btn-inverse btn-del"><i
                                class="fa fa-times m-r-5"></i> 删除法院</a>
                    </sec:ifAnyGranted>
                </div>
                <table id="data-table" class="table table-striped table-bordered display width-full">
                    ...
                    <tr>
                        ...
                        <th class="text-nowrap">法院名称</th>
                        <th class="text-nowrap">简称</th>
                        <th class="text-nowrap">分级码</th>
                        <th class="text-nowrap">服务地址</th>
                        <th class="text-nowrap">上级法院</th>
...
<asset:javascript src="distanceCourt/list.js"/>
<script>
