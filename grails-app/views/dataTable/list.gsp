    ...
    <div id="content" class="content">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">数据库列表</h4>
            </div>

            <div class="panel-body">
                <div class="table-btn-row m-b-15">
                    <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/courtroom/add'>
                        <g:if test="${deviceId != null}">
                            <g:link controller="dataTable" action="add" id="${deviceId}"
                                    class="btn btn-sm btn-inverse btn-add"><i
                                    class="fa fa-plus m-r-5"></i> 添加数据库</g:link>
                        </g:if>
                    </sec:ifAnyGranted>
                </div>
...
<asset:javascript src="dataTable/list.js"/>
<script>
