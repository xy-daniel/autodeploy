...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">添加数据库</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">添加数据库</h4>
            </div>

            <div class="panel-body">
                <g:form controller="dataTable" action="addSave" method="POST" data-parsley-validate="true">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="username" value="root"
...
<asset:javascript src="dataTable/add.js"/>
<script>
