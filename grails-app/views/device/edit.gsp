...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">编辑主机</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">编辑主机</h4>
            </div>

            <div class="panel-body">
                <g:form controller="device" action="editSave" id="${device.id}" method="POST"
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="name" value="${device.name}"
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="ip" value="${device.ip}"
                                       data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="port" value="${device.port}"
                                       data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="point" value="${device.point}"
                                       data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control m-b-5" name="pwd" value="${device.pwd}"
                                       data-parsley-required="true" data-parsley-required-message="此项不能为空"/>
                            </div>
                        </div>
                        <!-- end form-group row -->
