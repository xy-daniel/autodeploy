            ...
            <div class="panel-body">
                <div class="table-btn-row m-b-15">
                    <sec:ifAnyGranted roles='ROLE_SUPER,ROLE_ADMIN,ROLE_/courtroom/add'>
                        <g:link controller="device" action="add" class="btn btn-sm btn-inverse btn-add"><i
                                class="fa fa-plus m-r-5"></i> 添加主机</g:link>
                    </sec:ifAnyGranted>
                </div>
                <table id="data-table" class="table table-striped table-bordered display width-full">
                    <thead>
                    <tr>
                        <th class="text-nowrap">主机名称</th>
                        <th class="text-nowrap">主机地址</th>
                        <th class="text-nowrap">主机端口</th>
                        <th class="text-nowrap">用户名称</th>
                        <th class="text-nowrap">用户密码</th>
...
<asset:javascript src="device/list.js"/>
<script>
