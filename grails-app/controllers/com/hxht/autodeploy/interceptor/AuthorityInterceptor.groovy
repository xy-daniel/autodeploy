...
class AuthorityInterceptor {
    ...
    AuthorityInterceptor() {
        matchAll()
                ...
                .excludes(controller: "source")             //临时数据接口
                .excludes(controller: "self")               //个人信息
                .excludes(controller: "notify")             //系统通知
                .excludes(controller: "device")             //语音传唤
                .excludes(controller: "bailiff")            //法庭报警

                .excludes(controller: "message")            //领导端
                .excludes(controller: "leader")             //领导端
                .excludes(controller: "leaderApi")          //领导端接口

                .excludes(controller: "api")                //书记员软件
                .excludes(controller: "mobileApi")          //移动签名
                .excludes(controller: "apiNotice")          //庭显接口
                .excludes(controller: "remoteService")      //多方远程服务端接口
                .excludes(controller: "showVideo")          //东软直播点播
                .excludes(controller: "apiTaiChi")          //太极接口
                .excludes(controller: "apiVolumeControls")  //语音控制开关接口
                .excludes(controller: "apiVerification")    //评查系统调用所有历史数据接口
                .excludes(controller: "apiOfflinePlan")     //书记员客户端离线开庭数据上传接口
                .excludes(controller: "storeApi")           //存储调用接口

                .excludes(controller: "wfy")                //微法院
                .excludes(controller: "bm")                 //微法院
                .excludes(controller: "zhongheng")          //中恒信接口
    }
