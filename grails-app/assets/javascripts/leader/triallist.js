    ...
    var core = {
        ...
        render_table: function () {
            $('#data-table').DataTable({
                ...
                bProcessing: true,
                ajax: {
                    url: contextPath + 'leader/trialList',
                    type: "POST",
                    "data": function (d) {
                        //添加额外的参数传给服务器
                ...
                fnDrawCallback: function () {
                    ...
                    var canclePadding = $(".canclePadding");
                    for (var i = 0; i < canclePadding.length; i++) {
                        canclePadding[i].parentElement.setAttribute("style", "background: #348EE3;color: white")
                    }
                }
            });
        }
