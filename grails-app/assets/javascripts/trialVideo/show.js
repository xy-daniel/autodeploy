...
;-function (window) {
    ...
    var core = {
        ...
        handleVideo: function () { //处理视频方法
            ...
            console.log("当前通道号1：" + ready.chnNumber + " / 当前通道名称：" + ready.chnName);
        ...
        playVideo: function () {//点播视频
            ...
            console.log("当前点播地址2：" + url + " totalLength: " + totalLength);
            //初始化视频控件
            ready.player = new DPlayer({
                container: document.getElementById('video'),
                autoplay: true,
