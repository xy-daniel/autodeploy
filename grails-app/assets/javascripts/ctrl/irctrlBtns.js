    ...
    var core = {
        ...
        delPresets : function(){
            $('#delButtons').click(function () {
                swal({
                    ...
                    $.post(
                        contextPath + 'ctrl/delIrctrlBtns',
                        {
                            id:roomId,
                            irctrlUid:irctrlUid,
                            uuids:uuids
        ...
        editCp : function(){
            $(".editBtn").click(function () {
                ...
                window.location.href = contextPath + "ctrl/irctrl/button/edit/"+courtroom+"/"+ irctrlUid +"?uuid="+uuid;
            })
        },
        /**
