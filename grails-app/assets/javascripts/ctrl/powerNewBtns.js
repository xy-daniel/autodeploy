    ...
    var core = {
        ...
        delPresets : function(){
            $('#delButtons').click(function () {
                swal({
                    ...
                    var powerNewUid = $("#powerNewUid").val();
                    //选择所有的ck
                    ...
                    $.post(
                        contextPath + 'ctrl/delPowerNewBtns',
                        {
                            id:roomId,
                            powerNewUid:powerNewUid,
                            uuids:uuids
                        },
                        function (result) {
                            if (result.code === 0){
        ...
        editCp : function(){
            $(".editBtn").click(function () {
                ...
                window.location.href = contextPath + "ctrl/powerNew/button/edit/"+courtroom+"/"+ powerNewUid +"?uuid="+uuid;
            })
        },
        /**
